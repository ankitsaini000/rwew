 ...
 * @access  Private
 */
exports.createCreatorProfile = (0, express_async_handler_1.default)(async (req, res) => {
    console.log('Create creator profile request received with body:', req.body);
    try {
        // Check if user already has a profile
        const existingProfile = await CreatorProfile_1.CreatorProfile.findOne({ userId: req.user._id });
        if (existingProfile) {
        ...
        const profileData = Object.assign(Object.assign({}, req.body), { userId: req.user._id, status: 'draft', onboardingStep: 'personal-info', createdAt: new Date(), updatedAt: new Date(), metrics: {
                profileViews: 0,
        ...
        const creatorProfile = await CreatorProfile_1.CreatorProfile.create(profileData);
        if (creatorProfile) {
            ...
            await User_1.default.findByIdAndUpdate(req.user._id, { role: 'creator' });
            res.status(201).json({
                success: true,
                data: creatorProfile
            });
 ...
 * @access  Public
 */
exports.getCreators = (0, express_async_handler_1.default)(async (req, res) => {
    try {
 ...
 */
exports.getMyCreatorProfile = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        ...
        const creatorProfile = await CreatorProfile_1.CreatorProfile.findOneAndUpdate({ userId: req.user._id }, {
            $setOnInsert: {
                status: 'draft',
 ...
 * @access  Public
 */
exports.getPublicCreatorProfile = (0, express_async_handler_1.default)(async (req, res) => {
    try {
 ...
 * @access  Private
 */
exports.getProfileData = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        const creatorProfile = await CreatorProfile_1.CreatorProfile.findOne({ userId: req.user._id });
        if (!creatorProfile) {
            res.status(404);
            throw new Error('Creator profile not found');
        }
 ...
 * @access  Private
 */
exports.updateCreatorProfile = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        const userId = req.user._id;
        console.log('Updating creator profile for user:', userId);
        console.log('Request body:', req.body);
        // Find the creator profile
        let creatorProfile = await CreatorProfile_1.CreatorProfile.findOne({ userId });
        if (!creatorProfile) {
            res.status(404);
            throw new Error('Creator profile not found');
        }
        ...
        if (req.body.personalInfo) {
            ...
            creatorProfile.personalInfo = Object.assign(Object.assign({}, creatorProfile.personalInfo), req.body.personalInfo);
        ...
        const allowedFields = ['professionalInfo', 'descriptionFaq', 'socialMedia', 'pricing', 'galleryPortfolio', 'publishInfo', 'availability', 'metrics', 'completionStatus'];
        Object.keys(req.body).forEach(key => {
            if (key !== 'personalInfo' && key !== 'userId' && allowedFields.includes(key)) {
                creatorProfile[key] = req.body[key];
            }
        });
 ...
 * @access  Private
 */
exports.savePersonalInfo = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        ...
        if (Object.keys(userUpdates).length > 0) {
            await User_1.default.findByIdAndUpdate(req.user._id, userUpdates, { new: true });
 ...
 * @access  Private
 */
exports.saveProfessionalInfo = (0, express_async_handler_1.default)(async (req, res) => {
    var _a, _b, _c, _d, _e, _f, _g;
    try {
        console.log('Received professional info from frontend:', req.body);
        // Find creator profile
        let creatorProfile = await CreatorProfile_1.CreatorProfile.findOne({ userId: req.user._id });
        if (!creatorProfile) {
 ...
 * @access  Private
 */
exports.saveBasicInfo = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        // Find creator profile
        let creatorProfile = await CreatorProfile_1.CreatorProfile.findOne({ userId: req.user._id });
        if (!creatorProfile) {
 ...
 * @access  Private
 */
exports.saveDescription = (0, express_async_handler_1.default)(async (req, res) => {
    try {
 ...
 * @access  Private
 */
exports.saveSocialInfo = (0, express_async_handler_1.default)(async (req, res) => {
    try {
 ...
 * @access  Private
 */
exports.savePricing = (0, express_async_handler_1.default)(async (req, res) => {
    try {
 ...
 * @access  Private
 */
exports.saveRequirements = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        // Find creator profile
        let creatorProfile = await CreatorProfile_1.CreatorProfile.findOne({ userId: req.user._id });
        if (!creatorProfile) {
 ...
 * @access  Private
 */
exports.saveGallery = (0, express_async_handler_1.default)(async (req, res) => {
    var _a, _b;
    try {
        ...
        const profile = await CreatorProfile_1.CreatorProfile.findOneAndUpdate({ userId }, {
            $setOnInsert: {
                status: 'draft',
...
async function processGalleryData(profile, req, res) {
    ...
    try {
        ...
        try {
            ...
            const updatedProfile = await CreatorProfile_1.CreatorProfile.findById(profile._id);
            if (!updatedProfile) {
 ...
 * @access  Private
 */
exports.getCompletionStatus = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        const creatorProfile = await CreatorProfile_1.CreatorProfile.findOne({ userId: req.user._id });
        if (!creatorProfile) {
            res.status(404);
 ...
 * @access  Private
 */
exports.publishProfile = (0, express_async_handler_1.default)(async (req, res) => {
    var _a;
    try {
...
exports.checkUsername = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        ...
        const existingCreator = await CreatorProfile_1.CreatorProfile.findOne({ 'personalInfo.username': username });
 ...
 * @access  Private
 */
exports.upgradeToCreator = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        // Update user role to creator
        const user = await User_1.default.findByIdAndUpdate(req.user._id, { role: 'creator' }, { new: true });
        if (!user) {
            res.status(404);
            throw new Error('User not found');
        }
        ...
        if (!creatorProfile) {
            creatorProfile = await CreatorProfile_1.CreatorProfile.create({
                userId: req.user._id,
                status: 'draft',
                onboardingStep: 'personal-info'
            });
 ...
 * @access  Public
 */
exports.testCreator = (0, express_async_handler_1.default)(async (req, res) => {
    res.status(200).json({
        success: true,
 ...
 */
exports.forceCompleteProfile = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        // Find creator profile
        let creatorProfile = await CreatorProfile_1.CreatorProfile.findOne({ userId: req.user._id });
        if (!creatorProfile) {
 ...
 */
exports.emergencyFixProfile = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        ...
        const creatorProfile = await CreatorProfile_1.CreatorProfile.findOneAndUpdate({ userId }, Object.assign(Object.assign({}, req.body), { updatedAt: new Date() }), { new: true, upsert: true });
        res.status(200).json({
            success: true,
 ...
 */
exports.debugProfileData = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        ...
        // Find the profile
        const creatorProfile = await CreatorProfile_1.CreatorProfile.findOne({ userId }).populate('userId', 'email fullName role');
        if (!creatorProfile) {
            res.status(404);
            throw new Error('Creator profile not found');
        }
 ...
 * @access  Private
 */
exports.testGalleryStorage = (0, express_async_handler_1.default)(async (req, res) => {
    try {
...
exports.getPublishedCreators = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        ...
        if (priceMin) {
            filter['pricing.standard.price'] = { $gte: parseInt(priceMin) };
        }
        if (priceMax) {
            if (!filter['pricing.standard.price']) {
                filter['pricing.standard.price'] = {};
            }
            filter['pricing.standard.price'].$lte = parseInt(priceMax);
        }
        // Add follower count filters if provided
        if (followersMin) {
            filter['socialMedia.totalReach'] = { $gte: parseInt(followersMin) };
        }
        if (followersMax) {
            if (!filter['socialMedia.totalReach']) {
                filter['socialMedia.totalReach'] = {};
            }
            filter['socialMedia.totalReach'].$lte = parseInt(followersMax);
        }
        // Determine sort order
        let sortOptions = { 'metrics.profileViews': -1 }; // Default sort by popularity
        if (sortBy) {
            switch (sortBy) {
                case 'price-low':
        ...
        const total = await CreatorProfile_1.CreatorProfile.countDocuments(filter);
        console.log(`Found ${total} creators matching filters`);
        // Get creators with pagination
        const creators = await CreatorProfile_1.CreatorProfile.find(filter)
            .select('-__v')
...
const getCreatorDashboardData = async (req, res) => {
    try {
        ...
        const creatorMetrics = await CreatorMetrics_1.default.findOne({ creator: req.user._id }).lean();
        // Fetch the creator's orders with proper population
        const orders = await Order_1.default.find({ creator: req.user._id })
        ...
        const dashboardData = {
            metrics: {
                followers: (creatorMetrics === null || creatorMetrics === void 0 ? void 0 : creatorMetrics.followers) || 0,
                totalEarnings: totalEarnings,
                completedProjects: completedOrdersCount,
                pendingProjects: pendingOrdersCount,
                responseRate: (creatorMetrics === null || creatorMetrics === void 0 ? void 0 : creatorMetrics.responseRate) || 100,
                tierProgress: (creatorMetrics === null || creatorMetrics === void 0 ? void 0 : creatorMetrics.tierProgress) || 0,
                performanceData: (creatorMetrics === null || creatorMetrics === void 0 ? void 0 : creatorMetrics.performanceData) || {
                    views: [],
                    likes: [],
                    messages: [],
                    earnings: [],
            ...
            revenueByPromotion: (creatorMetrics === null || creatorMetrics === void 0 ? void 0 : creatorMetrics.revenueByPromotion) || [],
            revenueByMonth: (creatorMetrics === null || creatorMetrics === void 0 ? void 0 : creatorMetrics.revenueByMonth) || []
        };
...
exports.getCreatorDashboardData = getCreatorDashboardData;
/**
 * @desc    Fetch metrics from creatorprofiles and store in creatormetrics
 * @route   POST /api/creators/sync-metrics
 * @access  Private/Creator
 */
const syncCreatorMetrics = async (req, res) => {
    try {
        const creatorId = req.user._id;
        // Get creator profile with metrics and social media
        const creatorProfile = await CreatorProfile_1.CreatorProfile.findOne({ userId: creatorId })
        ...
        const profileMetricsData = creatorProfile.metrics || {};
        ...
        if (profileSocialMediaData && typeof profileSocialMediaData.socialProfiles === 'object') {
            ...
            platforms.forEach(platform => {
                const profile = profileSocialMediaData.socialProfiles[platform];
                if ((profile === null || profile === void 0 ? void 0 : profile.followers) !== undefined) {
                    totalFollowers += profile.followers;
                }
                else if ((profile === null || profile === void 0 ? void 0 : profile.subscribers) !== undefined) {
                    // Handle YouTube using subscribers
                    totalFollowers += profile.subscribers;
                }
                else if ((profile === null || profile === void 0 ? void 0 : profile.connections) !== undefined) {
        ...
        let creatorMetrics = await CreatorMetrics_1.default.findOne({ creator: creatorId });
        if (!creatorMetrics) {
            console.log(`No CreatorMetrics found for user ${creatorId}, creating new entry.`);
            creatorMetrics = new CreatorMetrics_1.default({
                creator: creatorId,
...
exports.syncCreatorMetrics = syncCreatorMetrics;
/**
 * @desc    Creator accepts an order
 * @route   POST /api/creators/orders/:orderId/accept
 * @access  Private/Creator
 */
exports.acceptOrder = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        const creatorId = req.user._id;
 ...
 * @access  Private
 */
exports.uploadProfileImage = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        const creatorProfile = await CreatorProfile_1.CreatorProfile.findOne({ userId: req.user._id });
        if (!creatorProfile) {
            res.status(404);
 ...
 * @access  Private
 */
exports.forceUpdateCompleteness = (0, express_async_handler_1.default)(async (req, res) => {
    ...
    const completionStatus = {
        personalInfo: Boolean(((_a = creatorProfile.personalInfo) === null || _a === void 0 ? void 0 : _a.firstName) && ((_b = creatorProfile.personalInfo) === null || _b === void 0 ? void 0 : _b.lastName)),
        professionalInfo: Boolean(((_c = creatorProfile.professionalInfo) === null || _c === void 0 ? void 0 : _c.title) && Array.isArray((_d = creatorProfile.professionalInfo) === null || _d === void 0 ? void 0 : _d.categories) && creatorProfile.professionalInfo.categories.length > 0),
        descriptionFaq: Boolean((_e = creatorProfile.descriptionFaq) === null || _e === void 0 ? void 0 : _e.briefDescription),
        socialMedia: Boolean((_h = (_g = (_f = creatorProfile.socialMedia) === null || _f === void 0 ? void 0 : _f.socialProfiles) === null || _g === void 0 ? void 0 : _g.instagram) === null || _h === void 0 ? void 0 : _h.url),
        pricing: Boolean((_l = (_k = (_j = creatorProfile.pricing) === null || _j === void 0 ? void 0 : _j.packages) === null || _k === void 0 ? void 0 : _k.basic) === null || _l === void 0 ? void 0 : _l.price),
        galleryPortfolio: Boolean(((_o = (_m = creatorProfile.galleryPortfolio) === null || _m === void 0 ? void 0 : _m.images) === null || _o === void 0 ? void 0 : _o.length) > 0)
    };
 ...
 */
const syncProfileImage = async (userId) => {
    var _a;
    try {
...
exports.syncProfileImage = syncProfileImage;
/**
 * @desc    Increment dashboardImpressions for a creator
 * @route   POST /api/creators/dashboard-impression
 * @access  Private (creator only)
 */
exports.dashboardImpression = (0, express_async_handler_1.default)(async (req, res) => {
    ...
    try {
        const updatedProfile = await CreatorProfile_1.CreatorProfile.findByIdAndUpdate(creatorId, { $inc: { dashboardImpressions: 1 } }, { new: true, upsert: false });
        // Also increment dashboardImpressions in CreatorMetrics
        if (updatedProfile && updatedProfile.userId) {
            await CreatorMetrics_1.default.findOneAndUpdate({ creator: updatedProfile.userId }, { $inc: { dashboardImpressions: 1 } }, { new: true, upsert: false });
        }
...
exports.deactivateCreator = (0, express_async_handler_1.default)(async (req, res) => {
    const { username } = req.params;
    const creator = await CreatorProfile_1.CreatorProfile.findOneAndUpdate({ 'personalInfo.username': username }, { isActive: false, status: 'suspended', deactivatedAt: new Date(), deactivationReason: 'Deactivated by admin' }, { new: true });
    if (!creator) {
    ...
    const userId = typeof creator.userId === 'object' && creator.userId !== null && 'toString' in creator.userId
        ...
        : creator.userId;
    const updatedUser = await User_1.default.findByIdAndUpdate(userId, { isActive: false, deactivatedAt: new Date(), deactivationReason: 'Deactivated by admin' }, { new: true });
 ...
 * @access  Admin
 */
exports.getSuspendedCreators = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        const suspendedCreators = await CreatorProfile_1.CreatorProfile.find({
            $or: [
                { status: 'suspended' },
                { isActive: false }
            ]
...
exports.reactivateCreator = (0, express_async_handler_1.default)(async (req, res) => {
    const { username } = req.params;
    const creator = await CreatorProfile_1.CreatorProfile.findOneAndUpdate({ 'personalInfo.username': username }, { isActive: true, status: 'published', deactivatedAt: null, deactivationReason: null }, { new: true });
    if (!creator) {
        res.status(404).json({ error: 'Not found' });
        return;
    }
    const userId = typeof creator.userId === 'object' && creator.userId !== null && 'toString' in creator.userId
        ? creator.userId.toString()
        : creator.userId;
    const updatedUser = await User_1.default.findByIdAndUpdate(userId, { isActive: true, deactivatedAt: null, deactivationReason: null }, { new: true });
    res.json({ success: true, data: { creator, user: updatedUser } });
});
/**
 ...
 * @access  Public
 */
exports.getSimilarCreators = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        const { searchQuery, searchResults = [], category, platform, priceRange, limit = 6 } = req.body;
        ...
        const searchResultIds = searchResults.map((creator) => creator._id || creator.id);
        ...
        if (searchResults.length > 0) {
            const categories = searchResults
                .map((creator) => { var _a; return (_a = creator.professionalInfo) === null || _a === void 0 ? void 0 : _a.categories; })
                .flat()
                .filter(Boolean);
            const subcategories = searchResults
                .map((creator) => { var _a; return (_a = creator.professionalInfo) === null || _a === void 0 ? void 0 : _a.subcategories; })
                .flat()
                .filter(Boolean);
        ...
        if (priceRange) {
            ...
            if (min || max) {
                ...
                if (min)
                    similarityFilter['pricing.standard.price'].$gte = min;
                if (max)
                    similarityFilter['pricing.standard.price'].$lte = max;
            }
        }
        ...
        let similarCreators = await CreatorProfile_1.CreatorProfile.find(similarityFilter)
            .select('-__v')
            .populate('userId', 'fullName username email avatar')
            .sort(sortOptions)
        ...
        if (similarCreators.length < limit) {
            ...
            const fallbackCreators = await CreatorProfile_1.CreatorProfile.find(fallbackFilter)
                .select('-__v')
                .populate('userId', 'fullName username email avatar')
        ...
        const processedCreators = diverseCreators.map((creator) => {
            var _a;
            const creatorId = creator._id ? creator._id.toString() : '';
            let username = '';
            if (creator.userId && typeof creator.userId === 'object') {
            ...
            return {
                ...
                username,
                fullName: creator.userId && creator.userId.fullName ? creator.userId.fullName : 'Creator',
                title: ((_a = creator.professionalInfo) === null || _a === void 0 ? void 0 : _a.title) || '',
                personalInfo: creator.personalInfo || {},
                professionalInfo: creator.professionalInfo || {},
                descriptionFaq: creator.descriptionFaq || {},
                socialMedia: creator.socialMedia || {},
 ...
 */
function applyDiversityAlgorithm(creators, limit) {
    var _a, _b, _c, _d;
    ...
    for (const creator of creators) {
        if (diverseCreators.length >= limit)
            break;
        const category = ((_b = (_a = creator.professionalInfo) === null || _a === void 0 ? void 0 : _a.categories) === null || _b === void 0 ? void 0 : _b[0]) || 'general';
        const price = ((_d = (_c = creator.pricing) === null || _c === void 0 ? void 0 : _c.standard) === null || _d === void 0 ? void 0 : _d.price) || 0;
